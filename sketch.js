let costas1, costas2;
let quieto, quieto2, farra1, farra2;
...
function draw() {
  ...
  if (mouseIsPressed || touches.length > 
    ...
    //Adicionando os estudantes lado a lado
    image(quieto, 50, CADEIRAS_Y, 
      200, 150);
    image(quieto2, 250, CADEIRAS_Y, 
      200, 150);
  }
}